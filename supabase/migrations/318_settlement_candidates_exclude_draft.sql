...
--   "최신 비-draft"다.
--
--   두 "최신"의 정의가 어긋나면서 아래 구조의 응모가 생긴다(운영 실측 14건 — 게시물 13·
--   영수증 1):
...
--
-- ── 정산 행 생성에 미치는 실질 영향 ──
--   이 변경으로 정산 후보(candidates 중 is_success=true)가 늘어난다(운영 실측 14건).
