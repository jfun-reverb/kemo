-- ═══════════════════════════════════════════════════════════════
-- 운영 배포 묶음 C — 현장 확인 화면 범위 가드 (마이그레이션 304)
-- 만든 날짜: 2026-08-06
--
-- ⚠️ 묶음 A(특히 283·287) 를 먼저 적용해야 합니다 — 이 파일은 check_in_ticket 을
--    재정의하므로 그 함수가 이미 있어야 합니다.
-- ⚠️ 이 파일 적용 뒤에는 **코드도 함께 나가야** 현장 확인이 동작합니다.
--    범위를 안 보내면 거부하도록(fail-closed) 만들어져, 옛 코드만 있으면 멈춥니다.
-- ═══════════════════════════════════════════════════════════════
