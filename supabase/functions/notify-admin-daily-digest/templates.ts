...
<!--
  ...
  Lang:    KO
  Skip:    5섹션 모두 0건이면 메일 미발송 + 발송 로그 status='skipped_no_data'
           ⚠️ 섹션 5 가 있으면 앞 네 절이 0건이어도 나간다(사양서 §2-6 — 의도)
  ...
  5섹션 구조:
    ...
    5. 조치가 필요한 캠페인 (action) — get_campaign_action_alerts()(마이그레이션 434)
                                  🔴 시간 창을 안 쓴다(오늘 기준 판정). 운영현황 일정 뷰와 같은 결과
