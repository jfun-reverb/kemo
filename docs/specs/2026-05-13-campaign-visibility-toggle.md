...
- **작성일**: 2026-05-13
- **작성**: 기획 세션
- **상태**: ✅ **운영 DB 배포 완료 (마이그레이션 129, 2026-05-18)** — post_deadline 컬럼 DROP + 캠페인 노출 토글 UI. **코드(admin.js)는 dev 잠재, main merge 보류 중**. 구현 결과 섹션 참조
- **실제 마이그레이션 번호**: 129 (122~128이 먼저 사용됨)
