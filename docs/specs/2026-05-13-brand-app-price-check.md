...
- **작성일**: 2026-05-13
- **작성**: 기획 세션
- **상태**: ✅ **운영 배포 완료 (DB 마이그레이션 없음 — 클라이언트 코드, 2026-05-13)** — `products[i].price_check` ('higher'|'lower'|'equal') 클라이언트 JSON 필드. 신청 목록 「가격체크」 드롭다운 컬럼 + 엑셀 내보내기 포함. 코드(admin.js)는 dev 잠재, main merge 보류 중
