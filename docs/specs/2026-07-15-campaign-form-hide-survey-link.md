...
- **견적/비용을 새 캠페인에 붙이는 대체 경로**는 이 사양 범위 밖(별도 논의) — 서베이 입구를 막으면 새 캠페인의 견적 연결 자리가 빈다
...
## 사용자 확인 필요
- (확인 완료) 정리 방식 = 안전 숨김(기존 연결 보존)
- (미정·별도) 서베이 입구를 막은 뒤 **새 캠페인의 견적 정보 연결 자리**를 어떻게 할지 — 이 사양 범위 밖. 견적 연결이 계속 필요하면 후속 기획.
