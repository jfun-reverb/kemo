...
메일 종류 카탈로그(`lookup_values(kind='admin_email_kind')` 시드 2건):
- `brand_notify` — 광고주 신청 접수 알림
- `application_cancel` — 인플루언서 응모 취소 일일 요약 메일
...
| `application_cancel` | 인플루언서 응모 취소 일일 요약 — Edge Function `notify-application-cancelled-daily` |
