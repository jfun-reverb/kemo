...
function addNbaProductRow() {
  ...
  row.style.cssText = 'display:grid;grid-template-columns:1.6fr 1.6fr 0.8fr 70px 1fr 32px;gap:8px;align-items:stretch;padding:8px 10px;background:var(--bg);border-radius:8px';
  row.innerHTML =
...
function _collectNbaProducts() {
  ...
  for (var i = 0; i < rows.length; i++) {
    ...
    if (!name && !nameJa && !price && !qty && !url) continue;  // 빈 행 스킵
