...
async function changePassword() {
  ...
  if (cur === nw) { err.textContent = (typeof t==='function') ? t('auth.pwSameAsCurrent') : '現在のパスワードと同じパスワードは使用できません。'; err.style.display='block'; return; }
  ...
  if (nw !== nw2) { err.textContent = (typeof t==='function') ? t('auth.pwMismatch') : 'パスワードが一致しません'; err.style.display='block'; return; }
