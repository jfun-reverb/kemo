    ...
    <div class="detail-main">
      ...
      ${(() => {
        ...
        const steps = (Array.isArray(camp.participation_steps) && camp.participation_steps.length)
          ...
          : legacy;
        return `
      <div style="background:#fff;padding:16px 0;margin-bottom:10px;border-bottom:8px solid var(--bg)">
      ...
      ${camp.product_url ? `
      <div style="background:#fff;padding:12px 0;margin-bottom:10px;border-bottom:8px solid var(--bg)">
