...
function renderBrandAppFlatRow(a, p, idx, count, isFirst, stripeClass) {
  ...
  // 17. 내부 메모 (제품 단위 — 모든 행)
  html += '<td><div class="brand-app-memo-cell" data-id="' + esc(a.id) + '" data-product-idx="' + idx + '" style="position:relative;min-height:36px">' + renderMemoCellInner(a, idx, p) + '</div></td>';
