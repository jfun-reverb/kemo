...
// ══════════════════════════════════════
const POLICY_NOTICE = {
  // 연령 정책(만 18세 이상) 시행 예고. 공고일 2026-06-20 → 시행일 2026-07-20(공고+30일).
  id: 'agePolicy2026',          // localStorage 키 식별자
  effectiveDate: '2026-07-20',  // 시행일(본문 {date}·예고 표기용) = 공고일+30일
  noticeUntil: '2026-08-03',    // 노출 종료일 = 시행일+14일. 이 날 0시(KST)부터 자동 비노출
};
