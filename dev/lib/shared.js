...
const UPCOMING_FEATURES = [
  // ⚠️ 임시 검증용 항목 (개발서버 D-day 카드 확인용 — 검증 후 제거 예정, 운영 배포 금지)
  {
    key: 'demo-soon',
    title: '[검증용] 예정 기능 샘플',
    desc: 'D-day 배지(주황)·카드 레이아웃 확인용 임시 항목입니다. 검증 후 제거합니다.',
    effectiveDate: '2026-07-15',
  },
  {
    key: 'demo-today',
    title: '[검증용] 당일 기능 샘플',
    desc: '시행 당일 D-DAY 배지(핑크) 확인용 임시 항목입니다.',
    effectiveDate: '2026-06-15',
  },
  {
    key: 'demo-done',
    title: '[검증용] 시행 완료 샘플',
    desc: '시행 후 14일 유지(초록) 확인용 임시 항목입니다.',
