...
// ══════════════════════════════════════
const POLICY_NOTICE = {
  // 개인정보처리방침 개정(메타 픽셀 §8.1 신설) 예고. 공고일 2026-09-17 → 시행일 2026-10-17(공고+30일).
  //   날짜의 정의처는 사양서 docs/specs/2026-09-17-meta-pixel-policy-notice.md §3 표.
  id: 'metaPixel2026',          // localStorage 키 식별자 — 통지마다 새 값(옛 값이면 지난 공지를 닫은 사람에게 안 뜬다)
  effectiveDate: '2026-10-17',  // 시행일(본문 {date}·예고 표기용) = 공고일+30일
  // 노출 종료일 = 시행일. 이 날 0시(KST)부터 자동 비노출.
  //   ⚠️ 연령 정책 때(시행일+14일)와 다르다 — 본문이 「공지 기간 안(10월 16일까지)에 …」를 말하므로
  //      시행일 뒤에 뜨면 이미 끝난 기간을 안내하게 된다.
  noticeUntil: '2026-10-17',
};
