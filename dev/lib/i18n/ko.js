...
window.I18N_KO = {
  ...
  policyNotice: {
    title: '「문의하기」 기능 추가·약관 개정 안내',
    body: '응모하신 캠페인별로 운영팀에 직접 문의할 수 있는 「문의하기」 기능이 추가되었습니다.<br><br>· 기능: 메시지 및 이미지<br>· 위치: 응모 이력 페이지 내 캠페인별<br>· 사용: 본인과 운영팀<br>· 보관 기간: 응모 종료 후 1년 (탈퇴 시 삭제)<br><br>이에 따라 이용약관·개인정보처리방침이 일부 개정되었습니다. 전문은 앱 하단 「이용약관」「개인정보처리방침」에서 확인하실 수 있습니다.<br><br>시행일: {date}',
    banner: '「문의하기」 기능 추가에 따라 약관·개인정보처리방침을 개정했습니다.',
    detailBtn: '자세히 보기',
    closeBtn: '다시 보지 않기',
  },
};
