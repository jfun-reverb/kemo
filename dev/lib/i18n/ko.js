...
window.I18N_KO = {
  ...
  event: {
    ...
    ticketPlaceLabel: '장소',
    ticketQrHint: '접수처에서 이 화면을 보여 주세요.',
    ...
    ticketCancelBtn: '예약 취소하기',
    ticketCancelConfirm: '이 예약을 취소합니다. 계속할까요?\n취소한 뒤에 다른 시간으로 다시 예약할 수 있습니다.',
    ticketCancelDone: '예약을 취소했습니다.',
    ticketCancelClosed: '시작 2시간 전이 지나 직접 취소할 수 없습니다. 운영진에게 연락해 주세요.',
    ticketCancelClosedShort: '취소 접수가 끝났습니다',
    ticketCancelFailEntered: '이미 입장해서 취소할 수 없습니다.',
  ...
  auth: {
    ...
    withdrawnLogout: '탈퇴 처리가 완료되어 로그아웃했습니다. 궁금한 점은 운영팀으로 LINE 연락해 주세요.',
    // 가입 확인 링크(?code=) 착지 안내 — ja.js 와 짝
    confirm: {
      done: '메일 인증이 완료되었습니다',
      doneLogin: '메일 인증이 완료되었습니다. 로그인해 주세요',
      linkExpired: '링크 유효기간이 지났습니다. 로그인을 시도해 주세요',
    },
    toast: {
  ...
  mypage: {
    ...
    // ── 회원 탈퇴 화면 (사양서 §4-4) ──
    //   ⚠️ 일본어(ja.js)와 **의미·단계 수가 같아야 한다.** 한쪽만 고치면 언어를 바꾼
    //      회원이 다른 안내를 본다.
    withdrawView: {
      title: '탈퇴에 대해',
      loading: '확인하고 있습니다…',
      aCancelApps: '취소할 수 있는 응모는 탈퇴와 함께 취소됩니다',
      aCancelAppsSub: '(결과물이 승인된 응모나 보수를 이미 받으신 응모는 그대로 남습니다)',
      aSchedule: '탈퇴 예정일을 알려 드립니다. 그날까지 5일간 탈퇴를 취소할 수 있습니다',
      aScheduleUnpaid: '받지 않으신 보수가 {n}건 있습니다. 지급이 끝난 뒤에 탈퇴 예정일을 알려 드립니다. 그날까지 5일간 탈퇴를 취소할 수 있습니다',
      aPaypal: '지급받으실 정보(PayPal)는 세금 신고를 위해 5년간 보관합니다',
      // ⚠️ 주어(「탈퇴를」)를 반드시 붙인다 — 이 문장에는 취소가 둘 나온다(탈퇴 취소 / 응모 취소)
      aIrreversible: '탈퇴를 취소하셔도, 취소된 응모는 되돌아오지 않습니다',
      aReasonLabel: '괜찮으시면 탈퇴 이유를 알려 주세요 (선택)',
      aReasonPlaceholder: '괜찮으시면 이유를 알려 주세요',
      aCancelBtn: '그만두기',
      aSubmitBtn: '탈퇴하기',
      aConfirm: '탈퇴 절차를 시작합니다. 취소된 응모는 되돌릴 수 없습니다.',
      bIntro: '지금은 직접 절차를 진행하실 수 없는 상태입니다. 운영팀이 확인한 뒤 처리해 드립니다.',
      bApproved: '승인된 결과물이 있는 응모: {n}건',
      bEvent: '행사(방문 예약) 응모: {n}건',
      bUnpaid: '받지 않으신 보수: {n}건',
      bOther: '응모나 보수 절차가 남아 있어서',
      bContact: '운영팀(LINE: @reverb.jp)으로 연락해 주세요. 담당자가 안내해 드립니다.',
      bBackBtn: '돌아가기',
      cTitle: '탈퇴 절차가 진행 중입니다',
      cBody: '받지 않으신 보수 지급이 끝난 뒤에 탈퇴 예정일을 메일로 알려 드립니다.',
      dScheduled: '탈퇴 예정일: {date}',
      // ⚠️ 「탈퇴 취소」로 부른다 — 예정일 안내 메일이 그 낱말을 쓴다(2026-08-21 결정).
      //    화면·메일·자주 묻는 질문 셋을 함께 볼 것.
      dCanCancel: '이날까지는 탈퇴를 취소하실 수 있습니다.',
      dCancelBtn: '탈퇴 취소',
      dCancelled: '탈퇴 절차를 취소했습니다. 취소된 응모는 되돌아오지 않으니 양해 부탁드립니다.',
      dCancelAdminOnly: '이 절차는 운영팀이 진행한 것이라 여기서는 취소하실 수 없습니다. 운영팀(LINE: @reverb.jp)으로 연락해 주세요.',
      eError: '지금은 확인할 수 없습니다. 잠시 후 다시 시도해 주세요.',
      eAudit: '이 계정은 탈퇴 절차 대상이 아닙니다.',
      eAdmin: '이 계정은 운영 측 권한이 있어 여기서는 절차를 진행할 수 없습니다. 운영팀(LINE: @reverb.jp)으로 연락해 주세요.',
      rTitle: '탈퇴 절차를 접수했습니다',
      rCancelled: '취소한 응모: {n}건',
      rUncancelled: '취소하지 못한 응모: {n}건',
      rUncancelledSub: '(결과물이 승인되었거나 하여 그대로 남습니다)',
      rAlready: '이미 절차가 진행 중입니다',
      // 2단계 — 확인 단계·처리 중·실패
      confirmTitle: '확인해 주세요',
      confirmBackBtn: '돌아가기',
      submitting: '처리하고 있습니다…',
      rDoneBtn: '닫기',
      rContact: '취소하지 못한 응모에 대해서는 운영팀(LINE: @reverb.jp)으로 문의해 주세요.',
      errLocked: '지금은 직접 절차를 진행하실 수 없는 상태입니다. 운영팀(LINE: @reverb.jp)으로 연락해 주세요.',
      errAlready: '이미 탈퇴 절차가 진행 중입니다. 화면을 새로고침해 확인해 주세요.',
      errReason: '고르신 이유가 올바르지 않습니다. 다시 골라 주세요.',
      errAuth: '로그인 상태를 확인해 주세요.',
      errUnknown: '절차를 진행하지 못했습니다. 잠시 후 다시 시도해 주세요.',
    },
    // 주의사항 비교 (Phase 2)
    caution: {
  ...
  detail: {
    ...
    blockedAnyChannel: '모집 채널 중 하나가 {n}명 이상이어야 합니다.',
    blockedYours: '당신의 팔로워 수:',
    blockedEachChannel: '{channel} {n}명 이상이 필요합니다(당신 {mine}명).',
    scheduledOverlay: '공개 예정',
    scheduledBtn: '공개 예정',
    notPublic: '이 캠페인은 현재 공개되지 않았습니다',
    deadlineJustPassed: '죄송합니다. 방금 모집 기간이 종료되었습니다. 다른 캠페인은 「캠페인 목록」에서 보실 수 있습니다',
    closedOverlay: '모집 마감',
    endedOverlay: '종료',
    fullOverlay: '모집 종료',
  ...
  authError: {
    ...
    signupHelp: '어려움이 있으시면 LINE으로 연락해 주세요.',
  ...
  // 정책 변경 통지 — 개인정보 처리방침 개정(메타 픽셀 §8.1 신설, 2026-09-17 공고 → 2026-10-17 시행)
  //   ⚠️ body 는 통지 메일(policy-change-notice) 블록 ②④⑤⑦ 과 같은 뜻. ⑤(끌 수 있습니다)가 ⑦(거부 의사)보다 반드시 앞.
  //      ⑤ 는 「끄다」, ⑦ 은 「거부 의사」 — 낱말을 섞지 않는다(ja.js 와 같은 구분).
  policyNotice: {
    title: '개인정보 처리방침 개정 안내',
    body: '늘 REVERB JP 를 이용해 주셔서 감사합니다.<br>더 나은 서비스 제공을 위해 개인정보 처리방침의 일부를 개정합니다. 아래 내용을 확인해 주세요.<br><br>■ 시행일<br>{date}<br><br>■ 주요 개정 내용<br>· 광고 효과를 측정하는 도구 「Meta 픽셀」 도입에 따라, 외부 서비스로의 정보 송신에 관한 사항을 신설합니다.<br><br>■ 회원 여러분께<br>· 이름·이메일·전화번호·배송지 등 회원 정보는 송신하지 않습니다.<br>· 이 송신은 쓰고 계신 브라우저의 설정(추적 방지 등)에서 끌 수 있습니다. 또 Facebook·Instagram 을 쓰시는 분은 본인 Meta 계정의 「광고 기본 설정」에서, 보내진 정보를 광고에 쓰는 것을 끌 수 있습니다.<br>· 꺼도 REVERB JP 는 지금까지와 똑같이 이용하실 수 있습니다.<br><br>개정 후 개인정보 처리방침에 동의하지 않으시는 경우 탈퇴(이용계약의 해지)를 신청하실 수 있습니다. 공지 기간 안(2026년 10월 16일까지)에 개정 내용에 대한 거부 의사를 표시하지 않으시면 개정 내용에 동의하신 것으로 간주합니다.<br>탈퇴는 메뉴의 「회원 탈퇴」에서 하실 수 있습니다.<br><br>자세한 내용은 앱 아래쪽 「개인정보 처리방침」에서 확인해 주세요.',
    banner: '개인정보 처리방침을 개정합니다(광고 효과 측정 도구 도입). 자세한 내용은 여기로.',
    detailBtn: '자세히 보기',
    closeBtn: '다시 보지 않기',
  },
};
