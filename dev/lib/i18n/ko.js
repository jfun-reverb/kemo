...
window.I18N_KO = {
  ...
  policyNotice: {
    title: '「메시지」 기능 추가·약관 개정 안내',
    body: '응모하신 캠페인별로 운영팀에 직접 문의할 수 있는 「메시지」 기능을 추가합니다.<br><br>· 보낼 수 있는 것: 글과 이미지<br>· 보관 기간: 응모 종료 후 1년 (탈퇴 시 삭제)<br>· 볼 수 있는 사람: 본인과 운영팀만<br><br>이에 따라 이용약관·개인정보처리방침을 일부 개정합니다. 전문은 앱 하단 「이용약관」「개인정보처리방침」에서 확인하실 수 있습니다.<br><br>시행일: {date}<br>문의는 공식 LINE @reverb.jp 으로.',
    banner: '「메시지」 기능 추가에 따라 약관·개인정보처리방침을 개정합니다.',
    detailBtn: '자세히 보기',
    closeBtn: '닫기',
  },
};
