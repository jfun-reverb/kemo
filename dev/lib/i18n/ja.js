...
window.I18N_JA = {
  ...
  mypage: {
    ...
    withdrawView: {
      ...
      aSchedule: '退会の予定日をお知らせします。その日まで5日間、取り消すことができます',
      // 미지급이 있으면 위 한 줄을 이것으로 갈아 끼운다(§4-4-2)
      aScheduleUnpaid: 'お受け取りでない報酬が{n}件あります。お支払いが終わってから、退会の予定日をお知らせします。その日まで5日間、取り消すことができます',
      aPaypal: 'お支払い先の情報（PayPal）は、税の申告のため5年間保管します',
      aIrreversible: '取り消しても、キャンセルされた応募は元に戻りません',
      ...
      dCanCancel: 'この日までは、退会をやめることができます。',
      dCancelBtn: '退会をやめる',
      dCancelled: '退会のお手続きを取り消しました。キャンセルされた応募は元に戻りませんので、ご了承ください。',
      dCancelAdminOnly: 'このお手続きは運営が行ったため、こちらでは取り消せません。運営（LINE：@reverb.jp）までご連絡ください。',
