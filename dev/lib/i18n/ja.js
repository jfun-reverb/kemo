...
window.I18N_JA = {
  ...
  // 政策変更の事前告知（メッセージ機能の規約改定、2026-05-27）
  policyNotice: {
    title: '「メッセージ」機能の追加・規約改定のお知らせ',
    body: '応募したキャンペーンごとに、運営チームへ直接お問い合わせができる「メッセージ」機能を追加します。<br><br>・送れるもの：文章と画像<br>・保管期間：応募終了後1年（退会時に削除）<br>・見られる人：ご本人と運営チームのみ<br><br>これにともない、利用規約・プライバシーポリシーを一部改定します。全文はアプリ下部の「利用規約」「個人情報処理方針」からご確認ください。<br><br>施行日：{date}<br>ご不明な点は公式LINE @reverb.jp まで。',
    banner: '「メッセージ」機能の追加にともない、規約・プライバシーポリシーを改定します。',
    detailBtn: '詳しく見る',
    closeBtn: '閉じる',
  },
};
